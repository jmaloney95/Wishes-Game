...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE},
    [MAPSEC_MUNEN_VILLAGE] = {MAP_GROUP(MAP_MUNEN_VILLAGE_2), MAP_NUM(MAP_MUNEN_VILLAGE_2), HEAL_LOCATION_MUNEN_VILLAGE},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_MUNEN_VILLAGE:
        // TEMP (testing): always flyable so Munen can be used as a fly/heal target.
