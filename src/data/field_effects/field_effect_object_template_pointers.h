...
extern const struct SpriteTemplate gFieldEffectObjectTemplate_WotRedLight;
extern const struct SpriteTemplate gFieldEffectObjectTemplate_WotRedSignLight;
