...
{
    // WoT: HMs are used by the TRAINER -- the "{mon} used X!" banner/cry pose
    // is skipped entirely. Callers wait for FLDEFF_FIELD_MOVE_SHOW_MON to not
    // be active, which is immediately true when it never starts.
