...
rock_pal=[(255,0,255),(80,66,57),(101,85,85),(130,186,126),(71,59,51),(53,45,39),(255,255,255),
          (125,106,106),(128,136,134),(86,159,107),(148,129,129),(150,196,146),
          (168,168,136),(144,136,112),(120,112,88),(184,184,152)]
PAL={10:tree_pal,11:water_pal,12:rock_pal}
def qrgb(rgb,pal):
...
def qtile(r,c,pal,bake=None):
    ...
    for y in range(8):
        for x in range(8):
            ...
            if (R,G,B)==(255,0,0): R,G,B=(130,186,126)
            if A<=16:
...
mark("grassymtn")
for (mr,mc) in [(40,6),(40,8),(40,10),(42,6),(42,10),(44,6),(44,8),(44,10)]:
    add_bottom(mr,mc,12)
add_bottom(64,4,12)
mark("stairs")
add_bottom(52,8,12)
...
wpal(f"{SEC}/palettes/10.pal",tree_pal); wpal(f"{SEC}/palettes/11.pal",water_pal); wpal(f"{SEC}/palettes/12.pal",rock_pal)
...
print("WF_START",WF_START)
print("grassymtn idx",n_old+idx["grassymtn"],"stairs idx",n_old+idx["stairs"],"..",n_old+idx["END"]-1)
