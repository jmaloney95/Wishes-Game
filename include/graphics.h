...
extern const u32 gBallGfx_Snag[];
extern const u16 gBallPal_Snag[];
...
extern const u32 gBattleEnvironmentTiles_RockDusk[];
extern const u32 gBattleEnvironmentTilemap_RockDusk[];
extern const u16 gBattleEnvironmentPalette_RockDusk[];
extern const u32 gBattleEnvironmentTiles_RockNight[];
extern const u32 gBattleEnvironmentTilemap_RockNight[];
extern const u16 gBattleEnvironmentPalette_RockNight[];
extern const u32 gBattleEnvironmentTiles_Torii[];
extern const u32 gBattleEnvironmentTilemap_Torii[];
extern const u16 gBattleEnvironmentPalette_Torii[];
extern const u32 gBattleEnvironmentTiles_ToriiDusk[];
extern const u32 gBattleEnvironmentTilemap_ToriiDusk[];
extern const u16 gBattleEnvironmentPalette_ToriiDusk[];
extern const u32 gBattleEnvironmentTiles_ToriiNight[];
extern const u32 gBattleEnvironmentTilemap_ToriiNight[];
extern const u16 gBattleEnvironmentPalette_ToriiNight[];
extern const u32 gBattleEnvironmentTiles_WotSea[];
extern const u32 gBattleEnvironmentTilemap_WotSea[];
extern const u16 gBattleEnvironmentPalette_WotSea[];
extern const u32 gBattleEnvironmentTiles_WotSeaDusk[];
extern const u32 gBattleEnvironmentTilemap_WotSeaDusk[];
extern const u16 gBattleEnvironmentPalette_WotSeaDusk[];
extern const u32 gBattleEnvironmentTiles_WotSeaNight[];
extern const u32 gBattleEnvironmentTilemap_WotSeaNight[];
extern const u16 gBattleEnvironmentPalette_WotSeaNight[];
extern const u32 gBattleEnvironmentTiles_WotCave[];
extern const u32 gBattleEnvironmentTilemap_WotCave[];
extern const u16 gBattleEnvironmentPalette_WotCave[];
extern const u32 gBattleEnvironmentTiles_WotAshlands[];
extern const u32 gBattleEnvironmentTilemap_WotAshlands[];
extern const u16 gBattleEnvironmentPalette_WotAshlands[];
extern const u32 gBattleEnvironmentTiles_WotLab[];
extern const u32 gBattleEnvironmentTilemap_WotLab[];
extern const u16 gBattleEnvironmentPalette_WotLab[];
extern const u32 gBattleEnvironmentTiles_WotSpace[];
extern const u32 gBattleEnvironmentTilemap_WotSpace[];
extern const u16 gBattleEnvironmentPalette_WotSpace[];
extern const u32 gBattleEnvironmentTiles_WotGraveyard[];
extern const u16 gBattleEnvironmentPalette_WotGraveyard[];
extern const u32 gBattleEnvironmentTilemap_WotGraveyard[];
extern const u32 gBattleEnvironmentTiles_WotTown[];
extern const u32 gBattleEnvironmentTilemap_WotTown[];
extern const u16 gBattleEnvironmentPalette_WotTown[];
extern const u32 gBattleEnvironmentTiles_WotIndoors[];
extern const u32 gBattleEnvironmentTilemap_WotIndoors[];
extern const u16 gBattleEnvironmentPalette_WotIndoors[];
...
extern const u16 gItemIconPalette_Craft[];
