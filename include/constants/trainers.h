...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_GOLD_ONI,
    TRAINER_PIC_FRONT_MUTRID_LEADER,
    TRAINER_PIC_FRONT_SWIMMER_ALLISON,
    TRAINER_PIC_FRONT_SWIMMER_SKYE,
    TRAINER_PIC_FRONT_SWIMMER_ROSA,
    TRAINER_PIC_FRONT_SWIMMER_MARINA,
    TRAINER_PIC_FRONT_MUTRID_GRUNT,
    TRAINER_PIC_FRONT_MUTRID_GRUNT_WHITE,
    TRAINER_PIC_FRONT_MUTRID_GRUNT_F,
    TRAINER_PIC_FRONT_MUTRID_GOON,
    TRAINER_PIC_FRONT_GENERAL_EDWARDS,
    TRAINER_PIC_FRONT_WOT_ALLISON_LAND,
    TRAINER_PIC_FRONT_WOT_SKYE_LAND,
    TRAINER_PIC_FRONT_WOT_ROSA_LAND,
    TRAINER_PIC_FRONT_WOT_MARINA_LAND,
    TRAINER_PIC_FRONT_WOT_REINA_VANESSA,
    TRAINER_PIC_FRONT_WOT_POKE_KID,
    TRAINER_PIC_FRONT_WOT_BEACH_GIRL,
