...
enum StringID
{
    ...
    // WoT Shadow system -- snagging (WoT_Act3_Canon.md §2.2)
    STRINGID_WOTGOTCHASNAGGED,
    STRINGID_WOTSNAGGEDTOPARTY,
    STRINGID_WOTSNAGGEDTOPC,
    STRINGID_WOTSHADOWAURA,
    STRINGID_WOTSNAGNICKNAMEQ,
    STRINGID_WOTCAUGHTTOPARTY,
    STRINGID_WOTCAUGHTTOPC,
    STRINGID_WOTHYPERMODE,
    STRINGID_WOTHYPERSETTLES,
    STRINGID_COUNT
};
