...
#define B_WAIT_TIME_MULTIPLIER              4     // This determines how long text pauses in battle last. Vanilla is 16. Lower values result in faster battles. (Wishes of Tomorrow: Turbo)
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            20         // % chance of encountering two Pokémon in a Wild Encounter. Wishes-of-Tomorrow: uncommon, not a staple.
#define B_DOUBLE_WILD_REQUIRE_2_MONS    TRUE       // If set to TRUE, Wild Double Battles will default to Single Battles when the player only has 1 usable Pokémon, ignoring B_DOUBLE_WILD_CHANCE and B_FLAG_FORCE_DOUBLE_WILD. Wishes-of-Tomorrow: TRUE, or the opening hours hand a lone starter a 2v1.
...
#define B_OBEDIENCE_MECHANICS           GEN_7      // GEN_7: obedience caps apply ONLY to traded/outsider Pokemon. The player's own-caught/gifted mons (e.g. the dev MEWTWO) always obey regardless of level or badges. (Was GEN_LATEST, which capped own mons by met level.)
