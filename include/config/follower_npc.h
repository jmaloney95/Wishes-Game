...
// NPC Followers
#define FNPC_ENABLE_NPC_FOLLOWERS                 TRUE // Enables the use of script macros to designate NPCs to follow behind the player, DPP style. Slightly increases the size of the saveblock (SaveBlock3). WoT: enabled for the Mikmanc jail escort (Act 3); old saves get their follower data cleared once in CB2_ContinueSavedGame.
