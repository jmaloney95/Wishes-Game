...
extern const u8 BattleScript_WotSuccessSnag[];
extern const u8 BattleScript_WotSuccessCatchNoEnd[];
extern const u8 BattleScript_WotHyperModeRampage[];
extern const u8 BattleScript_WotHyperModeHitsSelf[];
extern const u8 BattleScript_WotHyperModeSettles[];
